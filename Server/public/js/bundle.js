...
var createReview = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(rating, review, benefit, user) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
...
if (reviewForm) {
  reviewForm.addEventListener("submit", function (e) {
    ...
    (0, _createReview.createReview)(rating, review, benefit, user);
  });
}
