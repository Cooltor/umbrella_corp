    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 7:
          ...
          (0, _alerts.showAlert)("error", "Erreur de deconnexion, essayez encore.");
        case 10:
        case "end":
...
var signup = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(name, firstname, email, password, passwordConfirm) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
        ...
        case 3:
          res = _context.sent;
          if (res.data.status == "success") {
            (0, _alerts.showAlert)("success", "Inscription réussie");
            window.setTimeout(function () {
              location.assign("/");
            }, 1500);
          }
...
var create = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(type, title, description, price) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"updateBenefit.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateBenefit = exports.deleteBenefit = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
var updateBenefit = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(id, type, title, description, price) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === "success") {
            (0, _alerts.showAlert)("success", "Prestation modifiée avec succès");
            window.setTimeout(function () {
              location.assign("/les-prestations");
            }, 1500);
          }
  ...
  return function updateBenefit(_x, _x2, _x3, _x4, _x5) {
    return _ref.apply(this, arguments);
  };
}();
exports.updateBenefit = updateBenefit;
var deleteBenefit = /*#__PURE__*/function () {
  ...
  return function deleteBenefit(_x6) {
    return _ref2.apply(this, arguments);
  };
}();
...
var createReview = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(review, rating, benefit, user) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: "POST",
            url: "/api/v1/benefits/".concat(benefit, "/reviews"),
            data: {
              review: review,
              rating: rating,
              benefit: benefit,
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          res = _context.sent;
          if (res.data.status == "success") {
            (0, _alerts.showAlert)("success", "Email envoyé!");
            window.setTimeout(function () {
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"deleteUser.js":[function(require,module,exports) {
"use strict";
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === "success") {
            (0, _alerts.showAlert)("success", "Utilisateur supprimé avec succès!");
            window.setTimeout(function () {
...
var _updateBenefit = require("./updateBenefit");
...
var UserDataForm = document.querySelector(".form-name");
...
var deleteUserForm = document.querySelector(".form--deleteUser");
...
if (signupForm) {
  signupForm.addEventListener("submit", function (e) {
    ...
    (0, _signup.signup)(name, firstname, email, password, passwordConfirm);
  });
}
if (createForm) {
  createForm.addEventListener("submit", function (e) {
    ...
    (0, _create.create)(type, title, description, price);
  });
}
if (updateForm) {
  updateForm.addEventListener("submit", function (e) {
    ...
    (0, _updateBenefit.updateBenefit)(id, type, title, description, price);
  });
}
if (reviewForm) {
  reviewForm.addEventListener("submit", function (e) {
    ...
    var review = document.getElementById("review-new").value;
    var benefit = document.getElementById("benefit-id").value;
    var user = document.getElementById("user-id").value;
    (0, _createReview.createReview)(review, rating, benefit, user);
  });
}
if (forgotForm) {
