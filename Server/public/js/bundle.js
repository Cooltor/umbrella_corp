...
var updateData = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(name, firstname, email) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === "success") {
            (0, _alerts.showAlert)("success", "Modification(s) enregistrée(s) avec succès!");
            window.setTimeout(function () {
...
if (UserDataForm) {
  UserDataForm.addEventListener("submit", function (e) {
    ...
    (0, _updateSettings.updateData)(name, firstname, email);
  });
}
